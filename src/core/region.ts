...
export type VendorRegion = "cn_mainland" | "overseas";

export function vendorRegionForPin(lat: number, lng: number): VendorRegion {
  return isChinaMainland(lat, lng) ? "cn_mainland" : "overseas";
}
