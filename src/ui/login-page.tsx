    ...
    <PublicShell>
      <main id="content" className="auth-main">
        ...
        <p className="auth-links">
          <Link href="/reset-password">{t("eat.login.reset_link")}</Link>
          <Link href="/register">{t("eat.login.register_link")}</Link>
        </p>
      </main>
    </PublicShell>
  );
